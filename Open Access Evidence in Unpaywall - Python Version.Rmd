...
plt.legend(handles=[is_oa_patch, is_not_oa_patch], title='Is OA?',
           fontsize='medium', bbox_to_anchor=(1.2, 1.02), labelspacing=1.2)
...
Interestingly, the evidence type with the third highest number of related articles was not included in the database snapshot used in the mentioned blog post.
