...
|  1 | oa repository (via OAI-PMH doi match)                    |              5069032 |                             15.5  |                        31.83 |
...
It can be seen that an even distribution of intersection between publisher-based evidence sources and repository-based evidence types exists with respect to the subset. We can also observe that it is common that multiple repositories contribute to an intersection, which means that an open access full-text is often available by several repositories.
