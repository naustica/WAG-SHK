...
Next, we investigate the differences between the distribution of the host types specified in the data dumps. As mentioned in the blog article, the host type variable is determined by Unpaywall’s algorithm. 
